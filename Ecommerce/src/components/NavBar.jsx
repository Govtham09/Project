      ...
      <div className="container-fluid ms-5 ">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="buttons">
            ...
            <NavLink
              to="/cart"
              className="btn btn-outline-dark ms-3 btn-sm text-light btn-primary position-relative"
            >
              <i className="fa fa-shopping-cart me-2"></i>Cart
              <sup className="fw-bold badge bg-primary-subtle text-dark align-top ms-1 px-1">
                {state.length}
              </sup>
            </NavLink>
          </div>
